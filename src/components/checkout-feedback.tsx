...
export function CheckoutFeedbackButton() {
  ...
  return (
    <button
      ...
      className="flex-shrink-0 inline-flex items-center justify-center gap-1 min-h-[40px] px-2.5 rounded-full border border-brand-200 bg-brand-50 text-brand-800 text-xs font-semibold hover:bg-brand-100 active:bg-brand-200 touch-manipulation"
